...
--
-- Host: localhost
-- Generation Time: Jun 12, 2012 at 05:59 PM
...
--
-- Table structure for table `aic_assets`
--

CREATE TABLE IF NOT EXISTS `aic_assets` (
...
--
-- Dumping data for table `aic_assets`
--

INSERT INTO `aic_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(18, 1, 83, 84, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(32, 24, 98, 99, 1, 'com_users.notes.category.7', 'Uncategorised', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(35, 8, 20, 23, 2, 'com_content.category.8', 'About', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(36, 8, 24, 27, 2, 'com_content.category.9', 'Blog', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(37, 8, 28, 41, 2, 'com_content.category.10', 'Innovation Class', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(38, 37, 29, 32, 3, 'com_content.category.11', 'Professors', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(39, 37, 33, 34, 3, 'com_content.category.12', 'Resources', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(40, 37, 35, 36, 3, 'com_content.category.13', 'Latest Updates', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(41, 8, 42, 43, 2, 'com_content.category.14', 'Incubator', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(42, 8, 44, 51, 2, 'com_content.category.15', 'Research', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(43, 8, 52, 61, 2, 'com_content.category.16', 'Programs', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(44, 37, 37, 40, 3, 'com_content.category.17', 'About the Class', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(45, 42, 45, 46, 3, 'com_content.category.18', 'Research', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(46, 42, 47, 48, 3, 'com_content.category.19', 'Research Trusts', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(47, 42, 49, 50, 3, 'com_content.category.20', 'List of All Research', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(48, 43, 53, 54, 3, 'com_content.category.21', 'Interns and OJT Program', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(49, 43, 55, 56, 3, 'com_content.category.22', 'List of Interns and OJTs', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(50, 43, 57, 58, 3, 'com_content.category.23', 'Intern Program', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(51, 43, 59, 60, 3, 'com_content.category.24', 'Lecture Series', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(52, 8, 62, 63, 2, 'com_content.category.25', 'Donation', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(54, 35, 21, 22, 3, 'com_content.article.1', 'About the AIC', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(55, 36, 25, 26, 3, 'com_content.article.2', 'History of Silicon Valley and the Non-Silicon Valley History of the Philippines', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(56, 44, 38, 39, 4, 'com_content.article.3', 'About the Class', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(57, 38, 30, 31, 4, 'com_content.article.4', 'Professors', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(58, 1, 111, 112, 1, 'com_jce', 'jce', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `aic_associations`
--

CREATE TABLE IF NOT EXISTS `aic_associations` (
...
--
-- Table structure for table `aic_banners`
--

CREATE TABLE IF NOT EXISTS `aic_banners` (
...
--
-- Table structure for table `aic_banner_clients`
--

CREATE TABLE IF NOT EXISTS `aic_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `aic_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `aic_banner_tracks` (
...
--
-- Table structure for table `aic_categories`
--

CREATE TABLE IF NOT EXISTS `aic_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `aic_categories`
--

INSERT INTO `aic_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
(8, 35, 1, 13, 14, 1, 'about', 'com_content', 'About', 'about', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:09:21', 0, '0000-00-00 00:00:00', 0, '*'),
(9, 36, 1, 15, 16, 1, 'blog', 'com_content', 'Blog', 'blog', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:09:48', 0, '0000-00-00 00:00:00', 0, '*'),
(10, 37, 1, 17, 26, 1, 'innovation-class', 'com_content', 'Innovation Class', 'innovation-class', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:11:28', 0, '0000-00-00 00:00:00', 0, '*'),
(11, 38, 10, 20, 21, 2, 'innovation-class/professors', 'com_content', 'Professors', 'professors', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:11:58', 0, '0000-00-00 00:00:00', 0, '*'),
(12, 39, 10, 22, 23, 2, 'innovation-class/resources', 'com_content', 'Resources', 'resources', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:12:10', 0, '0000-00-00 00:00:00', 0, '*'),
(13, 40, 10, 24, 25, 2, 'innovation-class/latest-updates', 'com_content', 'Latest Updates', 'latest-updates', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:12:26', 0, '0000-00-00 00:00:00', 0, '*'),
(14, 41, 1, 27, 28, 1, 'incubator', 'com_content', 'Incubator', 'incubator', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:12:48', 0, '0000-00-00 00:00:00', 0, '*'),
(15, 42, 1, 29, 36, 1, 'research', 'com_content', 'Research', 'research', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:12:59', 0, '0000-00-00 00:00:00', 0, '*'),
(16, 43, 1, 37, 46, 1, 'programs', 'com_content', 'Programs', 'programs', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:13:34', 0, '0000-00-00 00:00:00', 0, '*'),
(17, 44, 10, 18, 19, 2, 'innovation-class/about-the-class', 'com_content', 'About the Class', 'about-the-class', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:16:13', 0, '0000-00-00 00:00:00', 0, '*'),
(18, 45, 15, 30, 31, 2, 'research/research', 'com_content', 'Research', 'research', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:16:33', 0, '0000-00-00 00:00:00', 0, '*'),
(19, 46, 15, 32, 33, 2, 'research/research-trusts', 'com_content', 'Research Trusts', 'research-trusts', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:16:46', 0, '0000-00-00 00:00:00', 0, '*'),
(20, 47, 15, 34, 35, 2, 'research/list-of-all-research', 'com_content', 'List of All Research', 'list-of-all-research', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:17:06', 0, '0000-00-00 00:00:00', 0, '*'),
(21, 48, 16, 38, 39, 2, 'programs/interns-and-ojt-program', 'com_content', 'Interns and OJT Program', 'interns-and-ojt-program', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:17:20', 0, '0000-00-00 00:00:00', 0, '*'),
(22, 49, 16, 40, 41, 2, 'programs/list-of-interns-and-ojts', 'com_content', 'List of Interns and OJTs', 'list-of-interns-and-ojts', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:17:36', 0, '0000-00-00 00:00:00', 0, '*'),
(23, 50, 16, 42, 43, 2, 'programs/intern-program', 'com_content', 'Intern Program', 'intern-program', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:17:47', 0, '0000-00-00 00:00:00', 0, '*'),
(24, 51, 16, 44, 45, 2, 'programs/lecture-series', 'com_content', 'Lecture Series', 'lecture-series', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:17:56', 0, '0000-00-00 00:00:00', 0, '*'),
(25, 52, 1, 47, 48, 1, 'donation', 'com_content', 'Donation', 'donation', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-12 06:18:08', 0, '0000-00-00 00:00:00', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `aic_contact_details`
--

CREATE TABLE IF NOT EXISTS `aic_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `aic_content`
--

CREATE TABLE IF NOT EXISTS `aic_content` (
...
--
-- Dumping data for table `aic_content`
--

INSERT INTO `aic_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 54, 'About the AIC', 'about-the-aic', '', '<h2 style="text-align: left;">About The Innovation Center:</h2>\r\n<p style="text-align: left;">The Ateneo Innovation Center (AIC) is Ateneo''s unique brand on Innovation where we promote and push for multidisciplinary collaboration inside but more importantly outside the country.</p>\r\n<p style="text-align: left;"> </p>\r\n<h2 style="text-align: left;">Vision:</h2>\r\n<p style="text-align: left;">To Empower Value-Creation in the country through Science and Technology Innovation.</p>\r\n<h2 style="text-align: left;">Mission:</h2>\r\n<p style="text-align: left;">To promote &amp; facilitate innovative research and solution development involving academe, industry and international partners, using a multidisciplinary and collaborative approaches and strategies.</p>\r\n<p style="text-align: left;"> </p>\r\n<h2 style="text-align: left;">Philosophy:</h2>\r\n<p style="text-align: left;"> <img src="images/aic/philosophy.jpg" border="0" alt="Philosophy Diagram. " /></p>\r\n<p style="text-align: left;">AIC engages the world.</p>\r\n<p style="text-align: left;">Solves real and pressing problems.</p>\r\n<p style="text-align: left;">Partners with experts and communities.</p>\r\n<p style="text-align: left;">And let our work speak for itself.</p>', '', 1, 0, 0, 8, '2012-06-12 06:33:51', 42, '', '2012-06-12 07:26:08', 42, 0, '0000-00-00 00:00:00', '2012-06-12 06:33:51', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 5, 0, 0, '', '', 1, 1, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 55, 'History of Silicon Valley and the Non-Silicon Valley History of the Philippines', 'history-of-silicon-valley-and-the-non-silicon-valley-history-of-the-philippines', '', '<p style="text-align: left;"><em>Excerpt and summary from the Ateneo Innovation Center''s study on Philippine Innovation</em></p>\r\n<p style="text-align: left;">Paul Graham founder of Y Combinator, one of the most successful Seed Venture Capital Firms wrote an essay in May 2006 "How to be Silicon Valley" where he stated that all you need to create a Silicon Valley like environment is to create a conducive place for innovation where there is an open and tolerant attitude. And where people go to to find and do something new...something like "California nuttiness".</p>\r\n<p style="text-align: left;">The top universities in the United States has their own innovation engines, MIT and Harvard have Boston Route 128 while Stanford and UC Berkley have the famous Silicon Valley. Both of them were born out of industry partnership with the academe, specifically in Stanford, with FederickTerman leading the charge of industry collaboration. Terman was the founder and father of the modern Silicon Valley, he single-handedly created the university, government, private industry triangle relationship that characterizes Silicon Valley in the 20th century. Hewlett Packard (HP), Litton Engineering Laboratories, Varian Labs, are the first examples of grossly successful companies that benefitted from the triangle relationship that Terman created. In less than 2 decades hundreds of Billions of dollars were created between the three companies creating the nucleus of the Silicon Valley.</p>\r\n<p style="text-align: left;">Palo Alto National Bank gave an initial loan to HP of $500 when no bank was willing to give a loan. HP never forgot this kindness and continued to do business with Palo Alto until the time it got too big for the small bank. Even then, it shifted business to an associate bank of Palo Alto. Inventors, Innovators and Entrepreneurs has a sense of responsibility to the people who has helped them during troubled times, and stayed loyal to them, this moral camaraderie among Silicon Valley companies has helped create an excessive amounts of wealth for all the parties involved.</p>\r\n<p style="text-align: left;">Today, venture capitalists always see the academe as the best source of entrepreneurs, but this was not the case before, it was because of Silicon Valley and Route 128 that made venture capitalists go to the top universities. In 1957, in Silicon Valley, Terman and Standord President Wally Sterling met George Montgomery and Tommy Davis of KCLD who wanted to invest in the electronics business. They wanted to create a system where they can combine KCLD''s capital between the university''s faculty, alumni and students to create new companies. KCLD then started to hire several Stanford engineering professors to provide "brain trust" to their fund and at the same time first crack access to different students, ideas and start-up companies. KCLD invested $900,000 in Watkins-Johnson and exited with more than $80M within a decade (88.9x). Arthur Rock, the successor to KCLD and continuing the tradition of having very close ties with Stanford invested in Apple Computer, Scientific Data Systems and Teledyne all of which returned enormous amounts to their limited partners. Scientific Data Systems (SDS) was sold to XEROX in 1969 for a princely sum of $990M. In Apple Inc. he invested $60,000 because Stanford was home of the Home Brew Computer Group where Apple was conceived and grew, with Apple Inc. being the most valuable company in the world,that small investment has produced amazing returns.</p>\r\n<p style="text-align: left;">Aside from Silicon Valley there are other examples of successful technology and innovation centers where industry and academic collaboration has created new wealth such as : The Research Park at the University of Illinois that produced the modern Internet Browser (Netscape), MGE Innovation Center of University of Wisconsin- Madison developed a non-invasive DNA test for colon cancer, and Exact Sciences its graduate company boasts a $160M market cap at NASDAQ and the ICEHouse of the University of Auckland (New Zealand) which has raised more than $50M in investments and 75 technology companies and is the star of industry-academe collaboration in New Zealand.</p>\r\n<p style="text-align: left;">The Philippines could not recreate Silicon Valley for hundreds of thousands of reasons but primarily because the Silicon Valley model is not really a model but a reflection of what makes Silicon Valley tick. What we can learn from the Silicon Valley story are how the different players interacted, how they view things and ultimately they played to their "difference" from other places that made them who they are right now.</p>', '', 1, 0, 0, 9, '2012-06-12 06:39:50', 42, '', '2012-06-12 14:50:20', 42, 0, '0000-00-00 00:00:00', '2012-06-12 06:39:50', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 5, 0, 0, '', '', 1, 2, '{"robots":"","author":"","rights":"","xreference":""}', 1, '*', ''),
(3, 56, 'About the Class', 'about-the-class', '', '<h2 style="text-align: left;">Innovation &amp; Technology I &amp; II (SC 195 &amp; SC 195.5)</h2>\r\n<p style="text-align: left;">Though technology plays a very important role in our lives, we seldom reflect on how a technological breakthrough happens or even on how it develops. This course is aimed at students as future technologists; the focus is on strategic thinking and the role of innovation in changing the technical landscape.</p>\r\n<p style="text-align: left;">We address questions like: what makes something hot, how new technologies have developed, what turns a given technology into a business success, and how do successful technologies lead to whole new industries?</p>\r\n<p style="text-align: left;">This course surveys themes like technology and society, creation of new technology companies based on new ideas, and global competitiveness. We will need to understand the technical basis of new developments but our objective is to understand the global context of technology development as well.</p>\r\n<p style="text-align: left;">&nbsp;</p>\r\n<h2 style="text-align: left;">Innovation &amp; Technology for the Base of the Pyramid (SC 195 &amp; SC 195.5)</h2>\r\n<p style="text-align: left;">This is an experiential course that brings to life creating innovations and technologies for the base-of-the-pyramid : the poor in society whose problems and needs have been unserved or underserved by traditional markets, products, and services.</p>\r\n<p style="text-align: left;">Students will not absorb through rote memorization, but rather learn from a healthy mix of case studies, creative problem solving, and field-based practical application, bringing them from mere theoretical knowledge to actual practice.</p>', '', 1, 0, 0, 17, '2012-06-12 06:41:28', 42, '', '2012-06-12 06:58:15', 42, 0, '0000-00-00 00:00:00', '2012-06-12 06:41:28', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 4, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 57, 'Professors', 'professors', '', '<h2 style="text-align: left;">Gregory Tangonan Ph.D</h2>\r\n<p style="text-align: left;">Dr. Tangonan retired in 2003 as Director of Research after Thirty-two years of R&amp;D experience with Hughes Research Laboratories with responsibilities for Innovation Strategy and conceptualization and execution of Research Programs with collaborators world-wide.</p>\r\n<p style="text-align: left;">He currently has 49 U.S. patents has published over 200 papers and made international presentations in the wide variety of fields like fiber optics, wireless communications, material science, and laser applications. He has also won the the prestigious R&amp;D 100 Award, in 1996 for all-optical switching modules that were developed for the world''s first demonstration of large scale all-optical networking and the second R&amp;D 100 Award was in 1989 for secure fiber optic systems that can detect intrusions into the fiber while transmitting clear data.&nbsp;He is currently the Executive Director of the Ateneo Innovation Center and the Commission on Science and Technology and Engineering for the Philippines (www.comste.gov.ph)</p>\r\n<p style="text-align: left;">&nbsp;</p>\r\n<h2 style="text-align: left;">Mark Ruiz</h2>\r\n<p style="text-align: left;">Mark Ruiz is an award winning social entrepreneur winning the World Economic Forum’s Asian Social Entrepreneur of the Year 2011, and AsiaSociety’s Philippine21 Young Leaders for 2008 among other local and international awards. He has represented Hapinoy.</p>\r\n<p style="text-align: left;">After working in Unilever Philippines for 7 years after graduating from Ateneo de Manila with a Bachelor of Science in Management Engineering he co-founded two massively successful and powerful social enterprises : Hapinoy (Microventures Inc.) and Rags2Riches.</p>\r\n<p style="text-align: left;">He is currently the President of MicroVentures Inc. the company that runs the Hapinoy Brand and a founding partner and Board of Director of Rags2Riches.</p>', '', 1, 0, 0, 11, '2012-06-12 06:45:35', 42, '', '2012-06-12 06:59:05', 42, 0, '0000-00-00 00:00:00', '2012-06-12 06:45:35', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 3, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `aic_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `aic_content_frontpage` (
...
--
-- Dumping data for table `aic_content_frontpage`
--

INSERT INTO `aic_content_frontpage` (`content_id`, `ordering`) VALUES
(2, 1);

-- --------------------------------------------------------

--
-- Table structure for table `aic_content_rating`
--

CREATE TABLE IF NOT EXISTS `aic_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `aic_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `aic_core_log_searches` (
...
--
-- Table structure for table `aic_extensions`
--
...
--
-- Dumping data for table `aic_extensions`
--

INSERT INTO `aic_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(13, 'com_media', 'component', 'com_media', '', 1, 1, 0, 1, '{"legacy":false,"name":"com_media","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_MEDIA_XML_DESCRIPTION","group":""}', '{"upload_extensions":"bmp,csv,doc,gif,ico,jpg,jpeg,odg,odp,ods,odt,pdf,png,ppt,swf,txt,xcf,xls,BMP,CSV,DOC,GIF,ICO,JPG,JPEG,ODG,ODP,ODS,ODT,PDF,PNG,PPT,SWF,TXT,XCF,XLS","upload_maxsize":"10","file_path":"images","image_path":"images","restrict_uploads":"1","check_mime":"1","image_extensions":"bmp,gif,jpg,png","ignore_extensions":"","upload_mime":"image\\/jpeg,image\\/gif,image\\/png,image\\/bmp,application\\/x-shockwave-flash,application\\/msword,application\\/excel,application\\/pdf,application\\/powerpoint,text\\/plain,application\\/x-zip","upload_mime_illegal":"text\\/html","enable_flash":"1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10003, 'Editor - JCE', 'plugin', 'jce', 'editors', 0, 1, 1, 0, '{"legacy":true,"name":"Editor - JCE","type":"plugin","creationDate":"19 May 2012","author":"Ryan Demmer","copyright":"2006-2010 Ryan Demmer","authorEmail":"info@joomlacontenteditor.net","authorUrl":"http:\\/\\/www.joomlacontenteditor.net","version":"2.1.3","description":"WF_EDITOR_PLUGIN_DESC","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10005, 'jce', 'component', 'com_jce', '', 1, 1, 0, 0, '{"legacy":true,"name":"JCE","type":"component","creationDate":"19 May 2012","author":"Ryan Demmer","copyright":"Copyright (C) 2006 - 2012 Ryan Demmer. All rights reserved","authorEmail":"info@joomlacontenteditor.net","authorUrl":"www.joomlacontenteditor.net","version":"2.1.3","description":"WF_ADMIN_DESC","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `aic_finder_filters`
--

CREATE TABLE IF NOT EXISTS `aic_finder_filters` (
...
--
-- Table structure for table `aic_finder_links`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links` (
...
--
-- Table structure for table `aic_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms0` (
...
--
-- Table structure for table `aic_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `aic_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `aic_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `aic_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `aic_finder_taxonomy`
--

INSERT INTO `aic_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `aic_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `aic_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `aic_finder_terms`
--

CREATE TABLE IF NOT EXISTS `aic_finder_terms` (
...
--
-- Table structure for table `aic_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `aic_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `aic_finder_terms_common`
--

INSERT INTO `aic_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `aic_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `aic_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `aic_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `aic_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `aic_finder_types`
--

CREATE TABLE IF NOT EXISTS `aic_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aic_languages`
--

CREATE TABLE IF NOT EXISTS `aic_languages` (
...
--
-- Dumping data for table `aic_languages`
--

INSERT INTO `aic_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `aic_menu`
--

CREATE TABLE IF NOT EXISTS `aic_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `aic_menu`
--

INSERT INTO `aic_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(107, 'main', 'JCE', 'jce', '', 'jce', 'index.php?option=com_jce', 'component', 0, 1, 1, 10005, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/logo.png', 0, '', 43, 52, 0, '', 1),
(108, 'main', 'WF_MENU_CPANEL', 'wf-menu-cpanel', '', 'jce/wf-menu-cpanel', 'index.php?option=com_jce', 'component', 0, 107, 2, 10005, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-cpanel.png', 0, '', 44, 45, 0, '', 1),
(109, 'main', 'WF_MENU_CONFIG', 'wf-menu-config', '', 'jce/wf-menu-config', 'index.php?option=com_jce&view=config', 'component', 0, 107, 2, 10005, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-config.png', 0, '', 46, 47, 0, '', 1),
(110, 'main', 'WF_MENU_PROFILES', 'wf-menu-profiles', '', 'jce/wf-menu-profiles', 'index.php?option=com_jce&view=profiles', 'component', 0, 107, 2, 10005, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-profiles.png', 0, '', 48, 49, 0, '', 1),
(111, 'main', 'WF_MENU_INSTALL', 'wf-menu-install', '', 'jce/wf-menu-install', 'index.php?option=com_jce&view=installer', 'component', 0, 107, 2, 10005, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-install.png', 0, '', 50, 51, 0, '', 1),
(112, 'mainmenu', 'About Us', 'about-us', '', 'about-us', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 53, 54, 0, '*', 0),
(113, 'mainmenu', 'Blog', 'blog', '', 'blog', 'index.php?option=com_content&view=category&layout=blog&id=9', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"layout_type":"blog","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","num_leading_articles":"1","num_intro_articles":"0","num_columns":"1","num_links":"0","multi_column_order":"","show_subcategory_content":"","orderby_pri":"","orderby_sec":"rdate","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 55, 56, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `aic_menu_types`
--

CREATE TABLE IF NOT EXISTS `aic_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `aic_menu_types`
--

INSERT INTO `aic_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `aic_messages`
--

CREATE TABLE IF NOT EXISTS `aic_messages` (
...
--
-- Table structure for table `aic_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `aic_messages_cfg` (
...
--
-- Table structure for table `aic_modules`
--

CREATE TABLE IF NOT EXISTS `aic_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `aic_modules`
--

INSERT INTO `aic_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `aic_modules_menu`
--

CREATE TABLE IF NOT EXISTS `aic_modules_menu` (
...
--
-- Dumping data for table `aic_modules_menu`
--

INSERT INTO `aic_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `aic_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `aic_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aic_overrider`
--

CREATE TABLE IF NOT EXISTS `aic_overrider` (
...
--
-- Table structure for table `aic_redirect_links`
--

CREATE TABLE IF NOT EXISTS `aic_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aic_schemas`
--

CREATE TABLE IF NOT EXISTS `aic_schemas` (
...
--
-- Dumping data for table `aic_schemas`
--

INSERT INTO `aic_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.4-2012-03-19');

-- --------------------------------------------------------

--
-- Table structure for table `aic_session`
--

CREATE TABLE IF NOT EXISTS `aic_session` (
...
--
-- Dumping data for table `aic_session`
--

INSERT INTO `aic_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('0mldjkvit58ojb5rma8b2lcm95', 0, 1, '1339516008', '__default|a:9:{s:15:"session.counter";i:25;s:19:"session.timer.start";i:1339510127;s:18:"session.timer.last";i:1339515597;s:17:"session.timer.now";i:1339516008;s:22:"session.client.browser";s:99:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.56 Safari/536.5";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":23:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:16:"com_mailto.links";a:2:{s:40:"3f3041eb76da85797092df5c1b7986e95f8d73fd";O:8:"stdClass":2:{s:4:"link";s:125:"http://localhost/aic-website/index.php/blog/2-history-of-silicon-valley-and-the-non-silicon-valley-history-of-the-philippines";s:6:"expiry";i:1339515597;}s:40:"6fcab3df9080524c9dd8c3223ed77b1f6ec1bd91";O:8:"stdClass":2:{s:4:"link";s:117:"http://localhost/aic/index.php/blog/2-history-of-silicon-valley-and-the-non-silicon-valley-history-of-the-philippines";s:6:"expiry";i:1339516008;}}s:13:"session.token";s:32:"652880e0f9d4d4e640a029e4e84ced8a";}', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `aic_template_styles`
--

CREATE TABLE IF NOT EXISTS `aic_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `aic_template_styles`
--

INSERT INTO `aic_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `aic_updates`
--

CREATE TABLE IF NOT EXISTS `aic_updates` (
...
--
-- Table structure for table `aic_update_categories`
--

CREATE TABLE IF NOT EXISTS `aic_update_categories` (
...
--
-- Table structure for table `aic_update_sites`
--

CREATE TABLE IF NOT EXISTS `aic_update_sites` (
...
--
-- Dumping data for table `aic_update_sites`
--

INSERT INTO `aic_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1339510147),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1339510149),
...
--
-- Table structure for table `aic_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `aic_update_sites_extensions` (
...
--
-- Dumping data for table `aic_update_sites_extensions`
--

INSERT INTO `aic_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(4, 10005);
...
--
-- Table structure for table `aic_usergroups`
--

CREATE TABLE IF NOT EXISTS `aic_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `aic_usergroups`
--

INSERT INTO `aic_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `aic_users`
--
...
--
-- Dumping data for table `aic_users`
--

INSERT INTO `aic_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`) VALUES
(42, 'Super User', 'admin', 'admin@domain.com', '6349c4820fc6f0f32624b68e57f89ff8:eHtmibEj7qPfpM4jaNGouUe05xu7ymQy', 'deprecated', 0, 1, '2012-06-12 05:50:22', '2012-06-12 14:09:03', '0', '');

-- --------------------------------------------------------

--
-- Table structure for table `aic_user_notes`
--

CREATE TABLE IF NOT EXISTS `aic_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `aic_user_profiles`
--

CREATE TABLE IF NOT EXISTS `aic_user_profiles` (
...
--
-- Table structure for table `aic_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `aic_user_usergroup_map` (
...
--
-- Dumping data for table `aic_user_usergroup_map`
--

INSERT INTO `aic_user_usergroup_map` (`user_id`, `group_id`) VALUES
(42, 8);

-- --------------------------------------------------------

--
-- Table structure for table `aic_viewlevels`
--

CREATE TABLE IF NOT EXISTS `aic_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `aic_viewlevels`
--

INSERT INTO `aic_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `aic_weblinks`
--

CREATE TABLE IF NOT EXISTS `aic_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `aic_wf_profiles`
--

CREATE TABLE IF NOT EXISTS `aic_wf_profiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `aic_wf_profiles`
--

INSERT INTO `aic_wf_profiles` (`id`, `name`, `description`, `users`, `types`, `components`, `area`, `rows`, `plugins`, `published`, `ordering`, `checked_out`, `checked_out_time`, `params`) VALUES
...
--
-- Table structure for table `s3k9t_assets`
--

CREATE TABLE IF NOT EXISTS `s3k9t_assets` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set parent.',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `s3k9t_assets`
--

INSERT INTO `s3k9t_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(35, 36, 21, 22, 3, 'com_content.article.1', 'About the AIC', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(36, 8, 20, 23, 2, 'com_content.category.8', 'About Us', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(37, 8, 24, 25, 2, 'com_content.category.9', 'Blog', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(38, 8, 26, 27, 2, 'com_content.category.10', 'Innovation Class', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(39, 8, 28, 29, 2, 'com_content.category.11', 'Incubator', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(40, 8, 30, 31, 2, 'com_content.category.12', 'Research', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(41, 8, 32, 33, 2, 'com_content.category.13', 'Programs', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(42, 8, 34, 35, 2, 'com_content.category.14', 'Labs', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(43, 8, 36, 37, 2, 'com_content.category.15', 'Partners', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(44, 8, 38, 39, 2, 'com_content.category.16', 'Donate', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_associations`
--

CREATE TABLE IF NOT EXISTS `s3k9t_associations` (
  `id` varchar(50) NOT NULL COMMENT 'A reference to the associated item.',
  `context` varchar(50) NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.',
  PRIMARY KEY (`context`,`id`),
...
--
-- Table structure for table `s3k9t_banners`
--

CREATE TABLE IF NOT EXISTS `s3k9t_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` int(11) NOT NULL DEFAULT '0',
  `type` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `s3k9t_banner_clients`
--

CREATE TABLE IF NOT EXISTS `s3k9t_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `contact` varchar(255) NOT NULL DEFAULT '',
  `email` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `s3k9t_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `s3k9t_banner_tracks` (
  `track_date` datetime NOT NULL,
  `track_type` int(10) unsigned NOT NULL,
  `banner_id` int(10) unsigned NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `s3k9t_categories`
--

CREATE TABLE IF NOT EXISTS `s3k9t_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `s3k9t_categories`
--

INSERT INTO `s3k9t_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:28:33', 0, '0000-00-00 00:00:00', 0, '*'),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users.notes', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:28:33', 0, '0000-00-00 00:00:00', 0, '*'),
(8, 36, 1, 13, 14, 1, 'about-us', 'com_content', 'About Us', 'about-us', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:26:18', 42, '2012-06-07 09:26:23', 0, '*'),
(9, 37, 1, 15, 16, 1, 'blog', 'com_content', 'Blog', 'blog', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:26:30', 0, '0000-00-00 00:00:00', 0, '*'),
(10, 38, 1, 17, 18, 1, 'innovation-class', 'com_content', 'Innovation Class', 'innovation-class', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:26:36', 0, '0000-00-00 00:00:00', 0, '*'),
(11, 39, 1, 19, 20, 1, 'incubator', 'com_content', 'Incubator', 'incubator', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:26:43', 0, '0000-00-00 00:00:00', 0, '*'),
(12, 40, 1, 21, 22, 1, 'research', 'com_content', 'Research', 'research', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:26:48', 0, '0000-00-00 00:00:00', 0, '*'),
(13, 41, 1, 23, 24, 1, 'programs', 'com_content', 'Programs', 'programs', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:26:55', 0, '0000-00-00 00:00:00', 0, '*'),
(14, 42, 1, 25, 26, 1, 'labs', 'com_content', 'Labs', 'labs', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:27:02', 0, '0000-00-00 00:00:00', 0, '*'),
(15, 43, 1, 27, 28, 1, 'partners', 'com_content', 'Partners', 'partners', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:27:08', 0, '0000-00-00 00:00:00', 0, '*'),
(16, 44, 1, 29, 30, 1, 'donate', 'com_content', 'Donate', 'donate', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2012-06-07 09:27:13', 0, '0000-00-00 00:00:00', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_contact_details`
--

CREATE TABLE IF NOT EXISTS `s3k9t_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `con_position` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `s3k9t_content`
--

CREATE TABLE IF NOT EXISTS `s3k9t_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `s3k9t_content`
--

INSERT INTO `s3k9t_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 35, 'About the AIC', 'about-the-aic', '', '<p><strong>Vision:</strong><br /> To Empower Value-Creation in the country through S&amp;T Innovation<br /><br /> <strong>Mission:<br /></strong>To promote &amp; facilitate innovative research and solution development involving academe, industry and international partners, using a multidisciplinary and collaborative approaches and strategies.</p>', '', 1, 0, 0, 8, '2012-06-06 07:13:27', 42, '', '2012-06-07 10:01:04', 42, 0, '0000-00-00 00:00:00', '2012-06-06 07:13:27', '0000-00-00 00:00:00', '{"image_intro":"images\\/aic\\/about-us2.jpg","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 6, 0, 0, '', '', 1, 9, '{"robots":"","author":"","rights":"","xreference":""}', 1, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `s3k9t_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `s3k9t_content_frontpage`
--

INSERT INTO `s3k9t_content_frontpage` (`content_id`, `ordering`) VALUES
(1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_content_rating`
--

CREATE TABLE IF NOT EXISTS `s3k9t_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `rating_sum` int(10) unsigned NOT NULL DEFAULT '0',
  `rating_count` int(10) unsigned NOT NULL DEFAULT '0',
  `lastip` varchar(50) NOT NULL DEFAULT '',
...
--
-- Table structure for table `s3k9t_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `s3k9t_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `s3k9t_extensions`
--

CREATE TABLE IF NOT EXISTS `s3k9t_extensions` (
  `extension_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `element` varchar(100) NOT NULL,
...
--
-- Dumping data for table `s3k9t_extensions`
--

INSERT INTO `s3k9t_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(1, 'com_mailto', 'component', 'com_mailto', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_mailto","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_MAILTO_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(2, 'com_wrapper', 'component', 'com_wrapper', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_wrapper","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_WRAPPER_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(3, 'com_admin', 'component', 'com_admin', '', 1, 1, 1, 1, '{"legacy":false,"name":"com_admin","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_ADMIN_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(4, 'com_banners', 'component', 'com_banners', '', 1, 1, 1, 0, '{"legacy":false,"name":"com_banners","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_BANNERS_XML_DESCRIPTION","group":""}', '{"purchase_type":"3","track_impressions":"0","track_clicks":"0","metakey_prefix":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(21, 'com_weblinks', 'component', 'com_weblinks', '', 1, 1, 1, 0, '{"legacy":false,"name":"com_weblinks","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_WEBLINKS_XML_DESCRIPTION","group":""}', '{"show_comp_description":"1","comp_description":"","show_link_hits":"1","show_link_description":"1","show_other_cats":"0","show_headings":"0","show_numbers":"0","show_report":"1","count_clicks":"1","target":"0","link_icons":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(22, 'com_content', 'component', 'com_content', '', 1, 1, 0, 1, '{"legacy":false,"name":"com_content","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_CONTENT_XML_DESCRIPTION","group":""}', '{"article_layout":"_:default","show_title":"0","link_titles":"0","show_intro":"0","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"1","show_vote":"0","show_readmore":"0","show_readmore_title":"0","readmore_limit":"100","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_noauth":"0","urls_position":"0","show_publishing_options":"1","show_article_options":"1","show_urls_images_frontend":"0","show_urls_images_backend":"1","targeta":0,"targetb":0,"targetc":0,"float_intro":"left","float_fulltext":"left","category_layout":"_:blog","show_category_title":"0","show_description":"0","show_description_image":"0","maxLevel":"1","show_empty_categories":"0","show_no_articles":"1","show_subcat_desc":"1","show_cat_num_articles":"0","show_base_description":"1","maxLevelcat":"-1","show_empty_categories_cat":"0","show_subcat_desc_cat":"1","show_cat_num_articles_cat":"1","num_leading_articles":"1","num_intro_articles":"4","num_columns":"2","num_links":"4","multi_column_order":"0","show_subcategory_content":"0","show_pagination_limit":"1","filter_field":"hide","show_headings":"1","list_show_date":"0","date_format":"","list_show_hits":"1","list_show_author":"1","orderby_pri":"order","orderby_sec":"rdate","order_date":"published","show_pagination":"2","show_pagination_results":"1","show_feed_link":"1","feed_summary":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(410, 'plg_editors_codemirror', 'plugin', 'codemirror', 'editors', 0, 1, 1, 1, '{"legacy":false,"name":"plg_editors_codemirror","type":"plugin","creationDate":"28 March 2011","author":"Marijn Haverbeke","copyright":"","authorEmail":"N\\/A","authorUrl":"","version":"1.0","description":"PLG_CODEMIRROR_XML_DESCRIPTION","group":""}', '{"linenumbers":"0","tabmode":"indent"}', '', '', 0, '0000-00-00 00:00:00', 1, 0),
(411, 'plg_editors_none', 'plugin', 'none', 'editors', 0, 1, 1, 1, '{"legacy":false,"name":"plg_editors_none","type":"plugin","creationDate":"August 2004","author":"Unknown","copyright":"","authorEmail":"N\\/A","authorUrl":"","version":"2.5.0","description":"PLG_NONE_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 2, 0),
(412, 'plg_editors_tinymce', 'plugin', 'tinymce', 'editors', 0, 1, 1, 1, '{"legacy":false,"name":"plg_editors_tinymce","type":"plugin","creationDate":"2005-2012","author":"Moxiecode Systems AB","copyright":"Moxiecode Systems AB","authorEmail":"N\\/A","authorUrl":"tinymce.moxiecode.com\\/","version":"3.4.9","description":"PLG_TINY_XML_DESCRIPTION","group":""}', '{"mode":"2","skin":"0","entity_encoding":"raw","lang_mode":"0","lang_code":"en","text_direction":"ltr","content_css":"1","content_css_custom":"","relative_urls":"1","newlines":"1","invalid_elements":"applet,iframe","extended_elements":"script","toolbar":"top","toolbar_align":"left","html_height":"550","html_width":"750","resizing":"true","resize_horizontal":"false","element_path":"1","fonts":"1","paste":"1","searchreplace":"1","insertdate":"1","format_date":"%Y-%m-%d","inserttime":"1","format_time":"%H:%M:%S","colors":"1","table":"1","smilies":"1","media":"1","hr":"1","directionality":"1","fullscreen":"1","style":"1","layer":"1","xhtmlxtras":"1","visualchars":"1","nonbreaking":"1","template":"1","blockquote":"1","wordcount":"1","advimage":"1","advlink":"1","advlist":"1","autosave":"1","contextmenu":"1","inlinepopups":"1","custom_plugin":"","custom_button":""}', '', '', 0, '0000-00-00 00:00:00', 3, 0),
(413, 'plg_editors-xtd_article', 'plugin', 'article', 'editors-xtd', 0, 1, 1, 1, '{"legacy":false,"name":"plg_editors-xtd_article","type":"plugin","creationDate":"October 2009","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_ARTICLE_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 1, 0),
(414, 'plg_editors-xtd_image', 'plugin', 'image', 'editors-xtd', 0, 1, 1, 0, '{"legacy":false,"name":"plg_editors-xtd_image","type":"plugin","creationDate":"August 2004","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_IMAGE_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 2, 0),
(415, 'plg_editors-xtd_pagebreak', 'plugin', 'pagebreak', 'editors-xtd', 0, 1, 1, 0, '{"legacy":false,"name":"plg_editors-xtd_pagebreak","type":"plugin","creationDate":"August 2004","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_EDITORSXTD_PAGEBREAK_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 3, 0),
(416, 'plg_editors-xtd_readmore', 'plugin', 'readmore', 'editors-xtd', 0, 1, 1, 0, '{"legacy":false,"name":"plg_editors-xtd_readmore","type":"plugin","creationDate":"March 2006","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_READMORE_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 4, 0),
...
--
-- Table structure for table `s3k9t_finder_links`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `s3k9t_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `s3k9t_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `state` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `s3k9t_finder_taxonomy`
--

INSERT INTO `s3k9t_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
  `node_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`node_id`),
  KEY `link_id` (`link_id`),
...
--
-- Table structure for table `s3k9t_finder_terms`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_terms` (
  `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `s3k9t_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL,
  KEY `idx_word_lang` (`term`,`language`),
  KEY `idx_lang` (`language`)
...
--
-- Dumping data for table `s3k9t_finder_terms_common`
--

INSERT INTO `s3k9t_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `s3k9t_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `s3k9t_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
  `map_suffix` char(1) NOT NULL,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
...
--
-- Table structure for table `s3k9t_finder_types`
--

CREATE TABLE IF NOT EXISTS `s3k9t_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `mime` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `s3k9t_languages`
--

CREATE TABLE IF NOT EXISTS `s3k9t_languages` (
  `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `lang_code` char(7) NOT NULL,
  `title` varchar(50) NOT NULL,
  `title_native` varchar(50) NOT NULL,
...
--
-- Dumping data for table `s3k9t_languages`
--

INSERT INTO `s3k9t_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_menu`
--

CREATE TABLE IF NOT EXISTS `s3k9t_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL COMMENT 'The type of menu this item belongs to. FK to #__menu_types.menutype',
  `title` varchar(255) NOT NULL COMMENT 'The display title of the menu item.',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'The SEF alias of the menu item.',
...
--
-- Dumping data for table `s3k9t_menu`
--

INSERT INTO `s3k9t_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(101, 'mainmenu', 'Home', 'home', '', 'home', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 7, '{"featured_categories":[""],"num_leading_articles":"1","num_intro_articles":"3","num_columns":"3","num_links":"0","orderby_pri":"","orderby_sec":"front","order_date":"","multi_column_order":"1","show_pagination":"2","show_pagination_results":"1","show_noauth":"","article-allow_ratings":"","article-allow_comments":"","show_feed_link":"1","feed_summary":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_readmore":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","show_page_heading":1,"page_title":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 29, 30, 1, '*', 0),
(102, 'mainmenu', 'About Us', 'about-us', '', 'about-us', 'index.php?option=com_content&view=article&id=1', 'component', -2, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 7, '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 45, 46, 0, '*', 0),
(103, 'mainmenu', 'About Us', 'about', '', 'about', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":["8"],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 47, 48, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_menu_types`
--

CREATE TABLE IF NOT EXISTS `s3k9t_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL,
  `title` varchar(48) NOT NULL,
  `description` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `s3k9t_menu_types`
--

INSERT INTO `s3k9t_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_messages`
--

CREATE TABLE IF NOT EXISTS `s3k9t_messages` (
  `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id_from` int(10) unsigned NOT NULL DEFAULT '0',
  `user_id_to` int(10) unsigned NOT NULL DEFAULT '0',
  `folder_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `s3k9t_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `s3k9t_messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(100) NOT NULL DEFAULT '',
  `cfg_value` varchar(255) NOT NULL DEFAULT '',
  UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`)
...
--
-- Table structure for table `s3k9t_modules`
--

CREATE TABLE IF NOT EXISTS `s3k9t_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL DEFAULT '',
  `note` varchar(255) NOT NULL DEFAULT '',
  `content` text NOT NULL,
...
--
-- Dumping data for table `s3k9t_modules`
--

INSERT INTO `s3k9t_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Main Menu', '', '', 1, 'menuload', 42, '2012-06-07 07:20:09', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(2, 'Login', '', '', 1, 'login', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '', 1, '*'),
(3, 'Popular Articles', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(4, 'Recently Added Articles', '', '', 4, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_latest', 3, 1, '{"count":"5","ordering":"c_dsc","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(8, 'Toolbar', '', '', 1, 'toolbar', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_toolbar', 3, 1, '', 1, '*'),
...
(79, 'Multilanguage status', '', '', 1, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_multilangstatus', 3, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(86, 'Joomla Version', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_version', 3, 1, '{"format":"short","product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(87, 'Twitter Feed', '', '<script src="http://widgets.twimg.com/j/2/widget.js"></script>\r\n<script>\r\nnew TWTR.Widget({\r\n  version: 2,\r\n  type: ''profile'',\r\n  rpp: 5,\r\n  interval: 30000,\r\n  width: 250,\r\n  height: 300,\r\n  theme: {\r\n    shell: {\r\n      background: ''#320032'',\r\n      color: ''#ffffff''\r\n    },\r\n    tweets: {\r\n      background: ''#160016'',\r\n      color: ''#ffffff'',\r\n      links: ''#00ffff''\r\n    }\r\n  },\r\n  features: {\r\n    scrollbar: true,\r\n    loop: false,\r\n    live: false,\r\n    behavior: ''all''\r\n  }\r\n}).render().setUser(''The_Real_t7r'').start();\r\n</script>', 1, 'position-6', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_custom', 1, 1, '{"prepare_content":"1","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(88, 'Ateneo Innovation Center on Facebook', '', '<script> \r\n      window.fbAsyncInit = function() { \r\n        FB.init({ \r\n        appId  : ''Roar'', \r\n        status : true, // check login status \r\n        cookie : true, // enable cookies to allow the server to access the session \r\n        xfbml  : true  // parse XFBML \r\n        }); \r\n      }; \r\n      (function() { \r\n      var e = document.createElement(''script''); \r\n      e.src = document.location.protocol + ''//connect.facebook.net/en_US/all.js''; \r\n      e.async = true; \r\n      document.getElementById(''fb-root'').appendChild(e); \r\n      }()); \r\n    </script>\r\n	      <script>(function(d, s, id) {\r\n      var js, fjs = d.getElementsByTagName(s)[0];\r\n      if (d.getElementById(id)) return;\r\n      js = d.createElement(s); js.id = id;\r\n      js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=169677216433872";\r\n      fjs.parentNode.insertBefore(js, fjs);\r\n      }(document, ''script'', ''facebook-jssdk''));</script>', 1, 'position-4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_custom', 1, 1, '{"prepare_content":"1","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_modules_menu`
--

CREATE TABLE IF NOT EXISTS `s3k9t_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `s3k9t_modules_menu`
--

INSERT INTO `s3k9t_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `s3k9t_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `s3k9t_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `s3k9t_overrider`
--

CREATE TABLE IF NOT EXISTS `s3k9t_overrider` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `constant` varchar(255) NOT NULL,
  `string` text NOT NULL,
  `file` varchar(255) NOT NULL,
...
--
-- Table structure for table `s3k9t_redirect_links`
--

CREATE TABLE IF NOT EXISTS `s3k9t_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `old_url` varchar(255) NOT NULL,
  `new_url` varchar(255) NOT NULL,
  `referer` varchar(150) NOT NULL,
...
--
-- Dumping data for table `s3k9t_redirect_links`
--

INSERT INTO `s3k9t_redirect_links` (`id`, `old_url`, `new_url`, `referer`, `comment`, `published`, `created_date`, `modified_date`) VALUES
(1, 'http://localhost/aic/index.php/about-us', '', 'http://localhost/aic/', '', 0, '2012-06-07 09:40:42', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_schemas`
--

CREATE TABLE IF NOT EXISTS `s3k9t_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `s3k9t_schemas`
--

INSERT INTO `s3k9t_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.4-2012-03-19');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_session`
--

CREATE TABLE IF NOT EXISTS `s3k9t_session` (
  `session_id` varchar(200) NOT NULL DEFAULT '',
  `client_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `guest` tinyint(4) unsigned DEFAULT '1',
  `time` varchar(14) DEFAULT '',
...
--
-- Dumping data for table `s3k9t_session`
--

INSERT INTO `s3k9t_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('afhsj8io0929ulk9rs5vorm6b3', 0, 1, '1339430301', '__default|a:8:{s:15:"session.counter";i:6;s:19:"session.timer.start";i:1339429370;s:18:"session.timer.last";i:1339430115;s:17:"session.timer.now";i:1339430300;s:22:"session.client.browser";s:99:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.56 Safari/536.5";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":23:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"daa6e57bd13340ae17c38c100da35245";}', 0, '', ''),
('k25avrabnfla2ihao5usmiq2r0', 1, 0, '1339430183', '__default|a:8:{s:15:"session.counter";i:12;s:19:"session.timer.start";i:1339430134;s:18:"session.timer.last";i:1339430182;s:17:"session.timer.now";i:1339430183;s:22:"session.client.browser";s:99:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.56 Safari/536.5";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:11:"com_content";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:7:"article";O:8:"stdClass":1:{s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":23:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:2:"42";s:4:"name";s:17:"AIC Website Admin";s:8:"username";s:5:"admin";s:5:"email";s:23:"castillo.fic3@gmail.com";s:8:"password";s:65:"f834815f7872b013644ebf194643dd20:ttmYrV3ggjoYmnQF2KiKjjPJqLzHoJ5g";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2012-06-06 06:45:22";s:13:"lastvisitDate";s:19:"2012-06-07 16:43:20";s:10:"activation";s:1:"0";s:6:"params";s:92:"{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":6:{s:11:"admin_style";s:0:"";s:14:"admin_language";s:0:"";s:8:"language";s:0:"";s:6:"editor";s:0:"";s:8:"helpsite";s:0:"";s:8:"timezone";s:0:"";}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"a405d9e6b8d758767226c9ccb2d9b444";}', 42, 'admin', '');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_template_styles`
--

CREATE TABLE IF NOT EXISTS `s3k9t_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `home` char(7) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `s3k9t_template_styles`
--

INSERT INTO `s3k9t_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - Default', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - Default', '{}'),
(4, 'beez_20', 0, '0', 'Beez2 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(6, 'beez5', 0, '0', 'Beez5 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/sampledata\\/fruitshop\\/fruits.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","html5":"0"}'),
(7, 'siteground-j16-41', 0, '1', 'siteground-j16-41 - Modded', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_updates`
--

CREATE TABLE IF NOT EXISTS `s3k9t_updates` (
  `update_id` int(11) NOT NULL AUTO_INCREMENT,
  `update_site_id` int(11) DEFAULT '0',
  `extension_id` int(11) DEFAULT '0',
  `categoryid` int(11) DEFAULT '0',
...
--
-- Table structure for table `s3k9t_update_categories`
--

CREATE TABLE IF NOT EXISTS `s3k9t_update_categories` (
  `categoryid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT '',
  `description` text NOT NULL,
  `parent` int(11) DEFAULT '0',
...
--
-- Table structure for table `s3k9t_update_sites`
--

CREATE TABLE IF NOT EXISTS `s3k9t_update_sites` (
  `update_site_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
  `location` text NOT NULL,
...
--
-- Dumping data for table `s3k9t_update_sites`
--

INSERT INTO `s3k9t_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1338965169),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1338965169);

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `s3k9t_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';
...
--
-- Dumping data for table `s3k9t_update_sites_extensions`
--

INSERT INTO `s3k9t_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700);
...
--
-- Table structure for table `s3k9t_usergroups`
--

CREATE TABLE IF NOT EXISTS `s3k9t_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Adjacency List Reference Id',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `s3k9t_usergroups`
--

INSERT INTO `s3k9t_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `s3k9t_users`
--

CREATE TABLE IF NOT EXISTS `s3k9t_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `username` varchar(150) NOT NULL DEFAULT '',
  `email` varchar(100) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `s3k9t_users`
--

INSERT INTO `s3k9t_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`) VALUES
(42, 'AIC Website Admin', 'admin', 'castillo.fic3@gmail.com', 'f834815f7872b013644ebf194643dd20:ttmYrV3ggjoYmnQF2KiKjjPJqLzHoJ5g', 'deprecated', 0, 1, '2012-06-06 06:45:22', '2012-06-11 15:55:42', '0', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}');

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_user_notes`
--

CREATE TABLE IF NOT EXISTS `s3k9t_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(100) NOT NULL DEFAULT '',
...
--
-- Table structure for table `s3k9t_user_profiles`
--

CREATE TABLE IF NOT EXISTS `s3k9t_user_profiles` (
  `user_id` int(11) NOT NULL,
  `profile_key` varchar(100) NOT NULL,
  `profile_value` varchar(255) NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `s3k9t_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `s3k9t_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `s3k9t_user_usergroup_map`
--

INSERT INTO `s3k9t_user_usergroup_map` (`user_id`, `group_id`) VALUES
(42, 8);

-- --------------------------------------------------------

--
-- Table structure for table `s3k9t_viewlevels`
--

CREATE TABLE IF NOT EXISTS `s3k9t_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `s3k9t_viewlevels`
--

INSERT INTO `s3k9t_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
(2, 'Registered', 1, '[6,2,8]'),
(3, 'Special', 2, '[6,3,8]');
...
--
-- Table structure for table `s3k9t_weblinks`
--

CREATE TABLE IF NOT EXISTS `s3k9t_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `sid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(250) NOT NULL DEFAULT '',
